...
const TeamSizeSelector = (props) => {
    return (
        <ButtonToolbar style={{margin: 15, width:420}} onClick={props.onClickHandler} className="lb-3" aria-label="Team Size">
            <ButtonGroup style={{width:420, align: 'centre' }} className="lr-2" aria-label="First group">
